...
def select_series_title_with_most_human_characters
  "SELECT series.title, COUNT(characters.series_id), characters.motto FROM characters INNER JOIN series ON characters.series_id = series.id GROUP BY characters.series_id;"
end

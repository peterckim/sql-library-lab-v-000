...
def select_series_title_with_most_human_characters
  "SELECT series.title, COUNT(characters.species) FROM characters INNER JOIN series ON characters.series_id = series.id GROUP BY characters.series_id, characters.species HAVING characters.species = 'human' ORDER BY COUNT(characters.species) DESC LIMIT 1;"
end

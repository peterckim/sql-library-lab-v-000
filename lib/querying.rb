...
def select_series_title_with_most_human_characters
  "SELECT series.title, COUNT(characters.name), characters.motto FROM characters INNER JOIN series ON characters.series_id = series.id GROUP BY series.id HAVING characters.species = 'human';"
end
